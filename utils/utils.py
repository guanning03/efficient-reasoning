...
DATASET_KEYS = {
    ...
    'benchmarks/gsm8k': {'question': 'question', 'answer': 'answer'},
...
RESPONSE_EXTRACTOR = {
    ...
    'benchmarks/gsm8k': lambda x: extract_answer(x, data_name='gsm8k'),
...
RESPONSE_COMPARATOR = {
    ...
    'benchmarks/gsm8k': lambda x, y: math_equal(x, y, timeout=True),
