...
# 数据准备
r1_1_5b = [0.8529, 2054.21]      # Pass Rate, Avg Tokens for R1-1.5B
r1_1_5b_rloo = [0.8666, 495.06]  # Pass Rate, Avg Tokens for R1-1.5B-RLOO
...
ax2.set_ylim(0, 2500)  # Avg Tokens的范围为0-2500
...
ax1.set_xticklabels(['R1-1.5B', 'R1-1.5B-RLOO'])
...
plt.savefig('rl_comparison.pdf', dpi=300, bbox_inches='tight')
plt.close()  # 关闭图形，释放内存